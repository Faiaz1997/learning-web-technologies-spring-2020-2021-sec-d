<?php
	...
	if(isset($_POST['submit']))
	{
		...
		if(($errorflag == false))
		{
				...
				$sql = "INSERT INTO `stuff` (`empno`, `Name`, `Email`, `Address`, `Phone`, `Salary`, `Position`, `Gender`,`DOB`, `Pass`) VALUES (NULL, '$name', '$email', '$address', '$phone', '$salary', '$position', '$gender', '$dob', '$password')";
